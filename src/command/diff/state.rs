...
pub struct AppState {
    ...
    pub watching: bool,
    /// preceipts receipts rail (bottom panel) visibility.
    pub receipts_panel: bool,
    /// Transient message shown in the receipts rail hint line.
    pub receipts_message: Option<String>,
...
impl AppState {
    pub fn new(file_diffs: Vec<FileDiff>, focus_file: Option<&str>) -> Self {
        ...
        Self {
            ...
            needs_reload: false,
            watching: false,
            receipts_panel: false,
            receipts_message: None,
            focused_hunk,
            annotations: Vec::new(),
